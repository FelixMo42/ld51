class Heap {
    ...
    sortDown(index) {
        ...
        while (this.heap[index].cost < this.heap[parent].cost) {
    ...
    sortUp(index) {
        while (true) {
            ...
            // is left bigger?
            if (left < this.heap.length && this.heap[left].cost < this.heap[max].cost) {
                max = left
            }
    
            // is even bigger?
            if (right < this.heap.length && this.heap[right].cost < this.heap[max].cost) {
                max = right
            }
